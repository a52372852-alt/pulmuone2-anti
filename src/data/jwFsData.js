export const COMPANY_INFO = {
  name: "주식회사 서진",
  slogan: "신선함과 안전을 다담은 학교급식 식자재 전문 대표기업",
  ceo: "서진 대표",
  established: "2012년 5월 10일",
  ...
  history: [
    ...
    { year: "2024", title: "전국 초·중·고등학교 및 지자체 우수 급식 식자재 공급처 선정" },
    { year: "2022", title: "식품안전의 날 우수 위생 관리 표창 수상" },
    { year: "2018", title: "HACCP(위생안전관리) 우수사업장 지정" },
    { year: "2015", title: "주식회사 서진 법인 전환 및 콜드체인 물류센터 설립" },
    { year: "2012", title: "서진 유통 설립" }
  ]
};
